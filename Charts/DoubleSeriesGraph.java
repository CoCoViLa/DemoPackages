...
class DoubleSeriesGraph {
    ...
    public void draw1( double x, double y ) {
        ...
        d[0] = getPrimDoubleArray( data1.keySet().toArray(
                new Double[data1.keySet().size()] ) );
        d[1] = getPrimDoubleArray( data1.values().toArray(
                new Double[data1.values().size()] ) );
    ...
    public void draw2( double x, double y ) {
        ...
        d[0] = getPrimDoubleArray( data2.keySet().toArray(
                new Double[data2.keySet().size()] ) );
        d[1] = getPrimDoubleArray( data2.values().toArray(
                new Double[data2.values().size()] ) );
